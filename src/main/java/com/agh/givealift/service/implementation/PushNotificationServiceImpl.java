...
public class PushNotificationServiceImpl implements PushNotificationService {
    ...
    public PushNotificationResponses findNotification2(List<SubscriptionResponse> subscriptionResponses) {
        if (subscriptionResponses.size() > 0) {
            ...
            cod.i(
                    subscriptionResponses.get(0).getSubscriber(),
                    Long.parseLong(subscriptionResponses.get(0).getSubscriber()),
                    pushNotificationRepository.find(Long.parseLong(subscriptionResponses.get(0).getSubscriber()))
            );
