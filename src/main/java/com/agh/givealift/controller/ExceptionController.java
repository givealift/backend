...
public class ExceptionController {
    ...
    public ResponseEntity<String> nullPassword(NullPasswordException e) {
        return new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_REQUEST);

    }   
    
       @ExceptionHandler(org.hibernate.exception.ConstraintViolationException.class)
    public ResponseEntity<String> validateExc(org.hibernate.exception.ConstraintViolationException e) {
        return new ResponseEntity<>(e.getMessage() + " " , HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<String> validateExc2(TransactionSystemException e) {
